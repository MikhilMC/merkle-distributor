...
describe("MerkleDistributorV2.sol", () => {
  ...
  beforeEach(async () => {
    ...
    MerkleDistributor = await ethers.getContractFactory("MerkleDistributorV2");
  ...
  describe("Correct Setup", () => {
    ...
    it("The merkle distributor have correct timelock", async () => {
      const timestamp = await merkleDistributor.timestamp();
    ...
    it("The merkle distributor have correct description", async () => {
      ...
      const expectedDescription =
        "Merkle Distributor contract with common timestamp";
